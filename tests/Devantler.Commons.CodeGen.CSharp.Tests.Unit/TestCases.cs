...
public static class TestCases
{
    public static IEnumerable<object[]> ValidCases =>
        new List<object[]>
        {
            ...
            new object[] { nameof(CSharpCodeCollectionFactory.CreateCSharpCodeCollectionStubWithOneEmptyEnum), CSharpCodeCollectionFactory.CreateCSharpCodeCollectionStubWithOneEmptyEnum() },
            new object[] { nameof(CSharpCodeCollectionFactory.CreateCSharpCodeCollectionStubWithOnePopulatedEnumWithSingleValue), CSharpCodeCollectionFactory.CreateCSharpCodeCollectionStubWithOnePopulatedEnumWithSingleValue() },
            new object[] { nameof(CSharpCodeCollectionFactory.CreateCSharpCodeCollectionStubWithOnePopulatedEnumWithMultipleValues), CSharpCodeCollectionFactory.CreateCSharpCodeCollectionStubWithOnePopulatedEnumWithMultipleValues() },
        };
